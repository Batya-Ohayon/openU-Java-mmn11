	...
	public static void main(String[] args) {
		...
		do//main loop: foreach game 
		{
			...
			{				
				...
				if(action.length() != 1 || (action.charAt(0) != '1' && action.charAt(0) != '2' )) 
				{JOptionPane.showMessageDialog(null, "You have to choose '1' or '2'","Bad Input",JOptionPane.ERROR_MESSAGE);}
